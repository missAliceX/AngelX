...
1. On the right panel, set reviewers, assignee, projects and labels as well. We will revisit milestone when we have a bigger project.
...
1. You now have a practical understanding on version control and software development process.
1. You wrote code from a tech spec with imperfect information.
1. You can intuitively look up resources outside of this guide to overcome programming challenges you have not faced before.
