...
Once your code is deemed ready. Ask your peer to review your changes. You will see pull requests in the [review requested tab](https://github.com/pulls/review-requested) when someone requests a review from you. It is strongly recommended that you find someone to work with you as it simulates the real life work experience. You may not have one so you can review it yourself for now.
...
If you forget to merge before starting another PR on a different branch, you may run into _code conflicts_. This generally only happens when you work with someone else on the same parts of the code. I'll host a web application that match you with people just like you to form teams and have you create something together. When that time comes, you will have to resolve code conflicts.

Code conflicts is the symptom of inevitable imperfection of planning & collaboration.
{: .notice}
